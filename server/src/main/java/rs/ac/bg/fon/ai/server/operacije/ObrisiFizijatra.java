 ...
 * @author milos
 */
public class ObrisiFizijatra extends ApstraktnaGenerickaOperacija {

    @Override
    protected void preduslovi(Object param) throws Exception {
        if (param == null || !(param instanceof Fizijatar)) {
            try {
                throw new Exception("BRISANJE FIZIJATRA NIJE USPELO");
            } catch (Exception ex) {
    ...
    protected void izvrsiOperaciju(Object objekat, String kljuc) {
        try {
            ...
            Logger.getLogger(ObrisiFizijatra.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
