 ...
 * @author milos
 */
public class DodajTipPacijenta extends ApstraktnaGenerickaOperacija {

    @Override
    protected void preduslovi(Object param) throws Exception {
        if(param==null||!(param instanceof TipPacijenta)){
            try {
                throw new Exception("DODAVANJE TIPA PACIJENTA NIJE USPELO");
            } catch (Exception ex) {
    ...
    protected void izvrsiOperaciju(Object objekat, String kljuc) {
        try {
            ...
            Logger.getLogger(DodajTipPacijenta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
