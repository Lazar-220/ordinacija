 ...
 * @author milos
 */
public class IzmeniPacijent extends ApstraktnaGenerickaOperacija {
    ...
    protected void preduslovi(Object param) throws Exception {
        if (param == null || !(param instanceof Pacijent)) {
            try {
                throw new Exception("AZURIRANJE PACIJENTA NIJE USPELO");
            } catch (Exception ex) {
    ...
    protected void izvrsiOperaciju(Object objekat, String kljuc) {
        try {
            ...
            uspeh=false;
            Logger.getLogger(IzmeniPacijent.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
